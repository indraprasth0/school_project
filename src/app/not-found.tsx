    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 355">
      <g id="ocean">
        ...
        <linearGradient
          ...
          y2="200.667"
        >
          <stop offset={0} stopColor={txtColor} />
          <stop offset={1} stopColor={btnColor} />
        </linearGradient>
      ...
      <g id="train">
        <path fill={txtColor} d="M344.5 248.5h507.2v37.8H344.5z" />
        <g id="wheels">
        ...
        <g id="car-layers">
          ...
          <g id="Text">
            ...
            <text
              transform="translate(510.5 220.994)"
              className="st8 st9"
              fontSize="40.025"
            >
              Result+
            ...
            <text
              transform="translate(710.5 213.994)"
              className="st8 st11"
              fontSize="22.025"
            >
              Page not found.
            ...
            <text
              transform="translate(550.5 280.994)"
              className="st8 st10"
              fontSize="16.025"
            >
              Let&apos;s go home.
